...
export function TestPatternPage(): React.ReactElement {
  ...
  return (
    ...
    >
      <motion.div variants={item} style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 32 }}>
        <div style={{ background: token.colorInfoBg, padding: 8, borderRadius: 12, display: 'flex' }}>
